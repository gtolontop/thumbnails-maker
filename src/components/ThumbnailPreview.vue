<template>
  ...
  >
    ...
    <div 
      ...
      style="background: radial-gradient(ellipse at center, rgba(33, 29, 235, 0.15) 0%, rgba(59, 130, 246, 0.08) 30%, rgba(59, 130, 246, 0.03) 60%, transparent 100%); filter: blur(40px);"
    ></div>
