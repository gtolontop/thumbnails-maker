<template>
  ...
  >
    <div v-if="!isTextOnly" id="default-layout" class="flex justify-between items-center w-full h-full">
      <div class="left-panel flex flex-col justify-center h-full w-1/2 relative -left-10">
        ...
        <div class="title-container relative">
          <h1 class="title text-[130px] font-extrabold leading-[1] m-0" style="color: #9EA4BE;">{{ configStore.titleText }}</h1>
    ...
    <div v-if="isTextOnly" id="text-only-layout" class="w-full h-full flex flex-col justify-between items-center py-[80px]">
